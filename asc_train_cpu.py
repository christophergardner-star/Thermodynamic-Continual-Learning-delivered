"""
Quarantined legacy ASC CPU entrypoint.
...
MESSAGE = (
    "asc_train_cpu.py is quarantined. This legacy CPU smoke script places the "
    "ASC warp network on a minimizing optimizer, so it is not a "
    "scientifically valid adversarial ASC trainer. Use `python "
    "asc_train_full.py` for the canonical min-max ASC path."
)
