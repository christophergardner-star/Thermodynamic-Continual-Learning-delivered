...
_PHASE_CATALOG: tuple[PhaseCatalogEntry, ...] = (
    ...
    PhaseCatalogEntry(
        logical_name="phase14_quantum_publishability",
        legacy_filename="phase14_quantum_publishability.json",
        phase_number=14,
        experiment_id="phase14_quantum_publishability",
        title="Phase 14 - Quantum Barren Plateau Publishability Study",
        dataset="synthetic_pennylane_ansatz",
        frontier_problem_id="fp-quantum-barren-plateau",
        target_paper_id="frontier-paper-fp-quantum-barren-plateau",
        target_paper_title="Barren Plateaus in Parameterised Quantum Circuits: Depth and Qubit Scaling",
        primary_domain_id="quantum_ml",
        research_goal="Characterise variance scaling with depth/qubit count for barren-plateau detection in PennyLane ansatz sweeps.",
    ),
    PhaseCatalogEntry(
